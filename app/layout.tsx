    ...
    <html lang="en">
      <body className="min-h-screen bg-black text-white">
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute -top-40 -left-44 h-[640px] w-[640px] rounded-full bg-blue-600/50 blur-[140px]" />
          <div className="absolute top-1/3 -right-44 h-[560px] w-[560px] rounded-full bg-amber-500/50 blur-[130px]" />
          ...
          <footer className="mt-20 border-t border-white/10 py-10 text-sm text-white/60">
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-wrap gap-4">
                <a className="hover:text-amber-400 transition" href="mailto:chris@khalilsystems.co.uk">
